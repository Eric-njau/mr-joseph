...
export default function CarCard({ car, onClick }: { car: Car; onClick: (id: number | string) => void }) {
  return (
    <div 
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-end mt-4 pt-4 border-t border-[var(--color-base)]/10">
          <div>
            ...
            <p className="text-lg font-light text-[var(--color-base)]">
              {car.price ? `Ksh ${car.price.toLocaleString()}` : 'POA'}
            </p>
          </div>
